...
FDL/
├── README.md                       # ← this file
├── .gitignore                      # ignores model checkpoints
...
│   ├── evaluation_metrics_a_to_z.md
│   ├── 5 phase mapping with 19 steps.md
│   ├── CLF Models/
...
│
├── Exam Guide/
│   ├── [FDL] Guide to the exam 2025_2026.pdf
│   └── FDL_exam_guide_compliance_audit.md
│
├── QA slide by slide.md            # 24-slide viva-prep Q&A guide
│
├── Sohan Vai/                      # reference papers for segmentation models
│   ├── Unet++.pdf
│   ├── attention U net from scratch.pdf
│   ├── attention U net pretrained.pdf
│   ├── trans U net.pdf
│   ├── script.docx / script.pdf / my script.md
│
├── Model test/                     # training-time experiment notebook
│   └── model test.ipynb
│
